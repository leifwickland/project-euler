object euler {
  val projects = Set[util.Project](project11, project16, project20, project13, project14, project25, project48, project336, project19, project28, project21, project8, project12, project18, project67, project15, project36, project22)
